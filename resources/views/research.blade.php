                    ...
                    <div class="col-xl-7 col-lg-6 align-self-center p-relative">
                        <div class="subheader-text">
                            <div class="page-title">
                                <h1 class="text-custom-white fw-600 text-left">Research</h1>
                    ...
                    <div class="col-12">
                        <div class="section-header">
                            <div class="section-heading">
                                ...
                                <h3 class="text-purple fw-700">All Natural Ingredients</h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-12">
        ...
        <div id="continuous-slider">
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Black Pepper</p>
                    </div>
                    <div class="img-box">
            ...
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Ginger</p>
                    </div>
                    <div class="img-box">
            ...
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Rosemarie</p>
                    </div>
                    <div class="img-box">
            ...
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Coconut</p>
                    </div>
                    <div class="img-box">
            ...
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Turmeric</p>
                    </div>
                    <div class="img-box">
            ...
            <div class="slide-item col-12">
                <div class="ingredients-wrap">
                    <div class="title">
                        <p class="bebas no-margin text-custom-white fw-500">Mint</p>
                    </div>
                    <div class="img-box">
                    ...
                    <div class="col-lg-12 what-you-get">
                        <div class="what-you-get-text accordion-2-collapse mb-md-80">
                            <div class="section-header left-side">
                                <div class="section-heading">
                                    <h3 class="text-brown fw-100"><span class="text-purple fw-700">Product</span> Principles</h3>
                                </div>
                            </div>
                            <div id="accordion">
                                <div class="card">
                            ...
                            <div id="accordion1">
                                ...
                                <div class="card">
                                    ...
                                    <div id="ingredients-2" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            <p class="text-brown fs-16 no-margin pb-16">National Digestive Diseases Information Clearinghouse (NDDIC). National Institute of Health. Your digestive system and how it works.</p>
                                ...
                                <div class="card">
                                    ...
                                    <div id="ingredients-3" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            <p class="text-brown fs-16 no-margin">Studies conducted by Rafatullah (2002), Suryanaraya et al (2004), Rao et al (2005) and Yokozawa (2007) demonstrated Amla’s healing efficacy in cases of stomach ulcer and carcinogen-induced liver ailments.<br/>
                                ...
                                <div class="card">
                                    ...
                                    <div id="ingredients-4" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            <p class="text-brown fs-16 no-margin pb-16">Hesperidin, a citrus bioflavonoid, inhibits bone loss and decreases serum and hepatic lipids in ovariectomized mice. J Nutr. 2003.
                                            </p>
                                            <p class="text-brown fs-16 no-margin pb-16">The purpose of this study was to examine whether hesperidin inhibits bone loss in ovariectomized mice (OVX), an animal model of postmenopausal osteoporosis. Hesperidin administration did not affect the uterine weight. These results suggest a possible role for citrus bioflavonoids in the prevention of lifestyle-related diseases because of their beneficial effects on bone and lipids.
                                            </p>
                                            <p class="text-brown fs-16 no-margin pb-16">Biological properties of citrus bioflavonoids pertaining to cancer and inflammation. Curr Med Chem. 2001. US Citrus and Subtropical Products Laboratory, USDA, ARS, SAA, Winter Haven, FL.
                                            </p>
                                            <p class="text-brown fs-16 no-margin">Antiproliferative activities of citrus bioflavonoids against six human cancer cell lines. J Agric Food Chem. 2002. U.S. Citrus and Subtropical Products Laboratory, South Atlantic Area, Agricultural Research Service, U.S. Department of Agriculture, Winter Haven, Florida Study conducted for the quantitative assessment of carotenoid antioxidants in human skin in vivo. Study was published in the December 2010 issue of the journal Archives of Biochemistry and BioPhysics.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="ingredients-5" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            <p class="text-brown fs-16 no-margin pb-16">Forskohlin clinical studies have been conducted in India, Japan and US. For clinical studies, visit <a href="https://www.forslean.com/" target="_blank">http://www.forslean.com/clinical.htm</a></p>
                                            <p class="text-brown fs-16 no-margin pb-16">GarCitrin clinical studies are available at <a href="http://www.garcitrin.com/clinical/" target="_blank">http://www.garcitrin.com/clinical/</a></p>
                                            <p class="text-brown fs-16 no-margin">Clinical studies on BioPerine are available at <a href="http://www.bioperine.com/clinical.html" target="_blank">http://www.bioperine.com/clinical.html</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                                    ...
                                    <div id="ingredients-6" class="collapse" data-parent="#accordion1">
                                        <div class="card-body">
                                            <p class="text-brown fs-16 no-margin">Picroliv prevents the biochemical changes triggered by aflatoxin B1. Rastogi et al. Pharmacol Toxicol. 2001; 88(2)')}:53-8.<br/>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="formula-top section-padding">
                            ...
                            <p class="text-custom-white no-margin text-left">Ultrra searches the world and researches traditional health-care systems for life-giving ingredients in the form of plants, herbs and minerals that support the body’s natural cleansing and rejuvenating functions. Ultrra products are formulated using empirical research and studies based on Ayurveda, Tibetan, Unani and Chinese Herbals supported by thousands of years of documentation</p>
                        </div>
