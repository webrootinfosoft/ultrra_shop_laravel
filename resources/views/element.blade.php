                ...
                <div class="col-xl-7 col-lg-6 align-self-center p-relative">
                    <div class="subheader-text">
                        <div class="page-title">
                            <h1 class="text-custom-white fw-600 text-left">Elements</h1>
            ...
            axios.get('/all-products', {params: {product_category_id: 12}}).then((response) => {
                ...
                response.data.data.map((product) => {
                    ...
                    html += "<div class=\"ul-categories-wrap section-padding\">\n" +
                        ...
                        "                    <a href='{{url('product-details2/')}}/"+product.id+"' class=\"theme-btn text-brown\"><div class=\"btn-text\">Learn More</div></a>\n" +
                        "                </div>\n" +
                        "            </div>\n" +
                        "            <div class=\"col-md-6\">\n" +
