                ...
                <div class="col-xl-7 col-lg-6 align-self-center p-relative">
                    <div class="subheader-text">
                        <div class="page-title">
                            <h1 class="text-custom-white fw-600 text-left">@lang('rareoil.Rare Oils')</h1>
                            <ul class="custom-flex breadcrumb">
                                <li>
                                    <a href="{{url('/')}}" class="td-none text-custom-white">@lang('rareoil.Home')</a>
                                </li>
                                <li>
                                    <a href="javascript:void(0)" class="td-none text-custom-white">@lang('rareoil.Products')</a>
                                </li>
                                <li class="text-custom-white active">
                                    @lang('rareoil.Rare Oils')
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            axios.get('/all-products', {params: {product_category_id: '{{$id}}'}}).then((response) => {
                ...
                response.data.data.map((product) => {
                    ...
                    html += "<div class=\"ul-categories-wrap section-padding\">\n" +
                        ...
                        "                    <a href='{{url('www/oils/')}}/"+product.id+window.location.search+"' class=\"theme-btn text-brown\"><div class=\"btn-text\">@lang("rareoil.Learn More")</div></a>\n" +
                        "                </div>\n" +
                        "            </div>\n" +
                        "            <div class=\"col-md-6\">\n" +
