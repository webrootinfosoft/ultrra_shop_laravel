            ...
            <div class="row">
                <div class="col-12">
                    <div class="seprator-text text-center">
                        ...
                        <a href="{{url('/research')}}" class="theme-btn bg-custom-black border-0"><span class="btn-text">Read More</span></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="category-slider">
            <div class="slide-item col-12" onclick="gotoCat('nutritional')">
                <div class="ul-category-box p-relative">
                    ...
                    <div class="ul-category-title text-center">
                        <h4 class="fw-600 title"><a href="{{url('/nutritional')}}" class="text-custom-black">Nutritionals</a></h4>
            ...
            <div class="slide-item col-12" onclick="gotoCat('rare-oil/15')">
                <div class="ul-category-box p-relative">
                    ...
                    <div class="ul-category-title text-center">
                        <h4 class="fw-600 title"><a href="{{url('/rare-oil')}}" class="text-custom-black">Rare Oils</a></h4>
            ...
            <div class="slide-item col-12" onclick="gotoCat('beverage')">
                <div class="ul-category-box p-relative">
                    ...
                    <div class="ul-category-title text-center">
                        <h4 class="fw-600 title"><a href="{{url('/beverage')}}" class="text-custom-black">Beverages</a></h4>
            ...
            <div class="slide-item col-12" onclick="gotoCat('element')">
                <div class="ul-category-box p-relative">
                    ...
                    <div class="ul-category-title text-center">
                        <h4 class="fw-600 title"><a href="{{url('/element')}}" class="text-custom-black">Elements</a></h4>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-12 text-center">
                    <a href="{{url('/opportunity')}}" class="theme-btn"><span class="btn-text">Read More</span></a>
                </div>
            </div>
        </div>
    </section>
        ...
        window.addEventListener('load', function(){
            ...
            $('#about-products-slider').slick({
                customPaging: function(slick,i) {
                    let image = i < 2 ? i + 2 : 1;
                    return '<a><img src="/images/featured-product'+image+'.png"/></a>';
                },
                dots: true,
